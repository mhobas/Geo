...
class alfolk_expense_personal(models.Model):
    ...
    customer = fields.Many2one('res.partner', string='Customer', store=True, required=True, index=True, tracking=True)
    ...
    note = fields.Char(string='Note', store=True, index=True, tracking=True, required=True)
